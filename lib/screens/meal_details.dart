...
import 'package:meals_app/utils/show_snack_bar.dart';
          ...
          IconButton(
            onPressed: () {
              ...
              if (isAddedToFavourites) {
                showInfoMessage(context, 'Meal added to favourites');
              } else {
                showInfoMessage(context, 'Meal removed from favourites');
              }
            },
